...
!(function () {
  ...
  if (
    ...
    var LINE = { stroke: "#000000", "stroke-width": 2, fill: "none" },
      RECT = { stroke: "#000000", "stroke-width": 2, fill: "#f5f5f5" };
    ...
    _.extend(RaphaelTheme.prototype, BaseTheme.prototype, {
      ...
      textBBox: function (text, font) {
        ...
        font.obj_
          ...
          : ((p = this.paper_.text(0, 0, text)), p.attr(font));
        var bb = p.getBBox();
        return p.remove(), bb;
      },
    ...
    var RaphaelHandTheme = function (diagram, options, resume) {
      this.init(
        diagram,
        _.defaults(options, { "font-size": 16, "font-family": "daniel" }),
        resume
      );
    };
  ...
  if (
    ...
    "undefined" == typeof Raphael && "undefined" == typeof Snap)
  )
